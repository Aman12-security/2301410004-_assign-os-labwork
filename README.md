...
Debugging tools and monitoring systems Concepts Used:  os.fork(), os.getpid(), os.getppid()  os._exit(), os.wait(), os.nice()  subprocess.run(), os.execvp()  Reading /proc/[pid]/status, /exe, and /fd
